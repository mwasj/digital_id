...
public class DigitalIdBuilder extends Thread
{
    ...
    public void run()
    {
        ...
        catch (IOException | JSchException e)
        {
            ...
            digitalID.sendUpdate(new WebUpdate("An exception has occurred, ", id, null, WebUpdateType.progressUpdate));
            digitalID.sendUpdate(new WebUpdate(null, id,
                    new CommandResponse(e.getMessage(), CommandResponseCode.Failure,
                            "An exception has occurred, ", new Command("An exception has occurred, ", 0, false, 0, true), null, null), WebUpdateType.progressUpdate));
        }
    }
}
